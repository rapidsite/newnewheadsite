...
const FancyBanner = () => {
  const bannerData = [
    {
      title: "EASY CHANGES TO YOUR SITE",
      mainTitle: "Make changes to your site, on the fly.",
      description:
        "We are currently buidling a dashboard for our clients to be able to change photos, information, & along with use our CRM suite & client pipeline linked to your site.",
      buttonLabel: "",
    ...
    {
      title: "SITE TRANSFER",
      mainTitle: "Super fast migration with no downtime.",
      description:
        "We build your site, host it, & prepare it to be deployed with your domain. No downtime, no hassle, no problem.",
      buttonLabel: "",
      illustration: "/images/assets/migration.png",
      illustrationAlt: "illustration",
      illustrationPosition: "right",
      aos: "fade-left",
    },
