...
const WebHosting = () => {
  return (
    <>
      <Seo pageTitle="Web Design Made Easy" />
              ...
              <div className="col-xxl-10 col-md-9 m-auto">
                ...
                >
                  <h2 className="main-title fw-bold tx-dark">
                    Solo, small business, or enterprise? We got you&nbsp;
          ...
          <div className="container">
            <div className="text-center mt-100 lg-mt-50 " data-aos="fade-up">
              <div className="d-inline-block consult-text fs-18 fw-500 tx-dark">
                ...
                help. <br></br>
                <a href="/contact" className="fw-normal text-decoration-underline">
                   Free Consultation
                </a>
              </div>
            </div>
          ...
          <div className="container">
            ...
            >
              <h2 className="main-title fw-bold tx-dark">
                ...
                <span className="position-relative d-inline-block">
                  important?
                  <img src="/images/shape/shape_95.svg" alt="illustration" />
                </span>
              </h2>
            </div>
            {/* /.title-style-seven */}
                  ...
                  <div className="row align-items-center">
                    <div className="col-xl-6 col-lg-5">
                      <h2 className="m0 text-white fw-bold md-pb-20">
                        Sign up & get your first month free.
                      </h2>
                    </div>
                    {/* End .col-6 */}
              ...
              <div className="row justify-content-between">
                ...
                <div className="col-xl-4 col-lg-5 mb-30 form-widget">
                  ...
                  <div className="fs-14 mt-10">
                    We send you tips to improve your website.
                  </div>
                </div>
                {/* End .col-xl-4 */}
              </div>
